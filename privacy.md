...
| **API Key Records** (`api_keys` table) | Permanently retained until you revoke them | Keys are credentials for access and need to be valid long-term. You can revoke them at any time through the developer console. |
...
|-----------|-----------------|-----------------|
| **API Key** | Revoke it yourself in the developer console | Immediate |
| **Event Record** | Send an email to `signal@humanjudgment.org` with the record ID and your API key | Within 30 days |
| **All Data for an Email** | Send an email to `signal@humanjudgment.org` with the email address and API key | Within 30 days |
...
All data is stored on servers located in **Singapore** with industry-standard cloud infrastructure providers. The Singapore Personal Data Protection Act (PDPA) is widely regarded as a standard comparable to the GDPR.
...
| **Network Security** | Servers are located in a Virtual Private Cloud, with non-essential ports closed by default. |
...
|------------------|---------|----------------|
| **Cloud Infrastructure Provider** | Application hosting, database, static files | Available upon request |
...
|--------|---------|-------------|
| **Email** | `signal@humanjudgment.org` | For all inquiries (please mention "Privacy" in subject line) |
| **GitHub Issues** | [hjs-api/issues](https://github.com/hjs-protocol/api/issues) | Please do not submit sensitive data in Issues |
